...
# Specify metadata & service attributes for Lena test image
...
DATA_metadata = {
    "main": {
        ...
        "files": [
	  {
	    "url": "https://raw.githubusercontent.com/calina-c/ocean-lena/main/lena.png",
	    "index": 0,
	    "contentType": "text/text"
	  }
	],
	"name": "lena", "author": "Calina", "license": "CC0",
...
ALG_metadata =  {
    "main": {
        ...
        "files": [
	  {
	    "url": "https://raw.githubusercontent.com/calina-c/ocean-lena/main/grayscale.py",
	    "index": 0,
	    "contentType": "text/text",
	  }
	],
	"name": "pil-grayscale", "author": "Calina", "license": "CC0",
